...
SerialWombatChip sw;
SerialWombatRandomBlink randomBlink0(sw),randomBlink1(sw),randomBlink2(sw),randomBlink3(sw),randomBlink4(sw),randomBlink5(sw),randomBlink6(sw),randomBlink7(sw);
...
void setup() {
  ...
  randomBlink1.write1stOrderFiltering(SerialWombatAbstractScaledOutput::PERIOD_16mS, 0xF000);  // Values closer to zero slow things down, closer to 0xFFFF speed things up
...
// Add first order filtering using the Serial Wombat scaled output capability.
  ...
  // filters that target before writing it to the physical output.
  // Higher filter constants produce slower transitions.
  randomBlink6.write1stOrderFiltering(SerialWombatAbstractScaledOutput::PERIOD_16mS, 0xF000);  // Values closer to zero slow things down, closer to 0xFFFF speed things up
